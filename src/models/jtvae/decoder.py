...
from src.models.fast_jtnn.mol_tree import MolTree, MolTreeNode
from src.utils.nnutils import create_var, GRU
...
class JTNNDecoder(nn.Module):
    ...
    def aggregate(self, hiddens, contexts, x_tree_vecs, mode):
        ...
        if tree_contexts.dim() == 3:
            tree_contexts = tree_contexts.sum(dim=1)
        #print(hiddens.size(), tree_contexts.size())
    ...
    def decode(self, x_tree_vecs, prob_decode):
        ...
        #print('x_tree_vecs:', x_tree_vecs.size())
        stack = []
